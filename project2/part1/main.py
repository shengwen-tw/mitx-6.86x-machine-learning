...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print("test_error_mod3 without retraining = {}".format(test_error_mod3))
    ...
    test_error_mod3 = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)
    print("test_error_mod3 with retraining = {}".format(test_error_mod3))
...
test_error_18d_pca = compute_test_error(test_pca, test_y, theta, temp_parameter)
print("test_error_18d_pca = {}".format(test_error_18d_pca))
...
test_error_18d_pca = compute_test_error(test_cube, test_y, theta, temp_parameter)
print("test_error_pca10_cubic = {}".format(test_error_18d_pca))

pred_test_y = svm_poly3(train_pca10, train_y, test_pca10)
test_error = compute_test_error_svm(test_y, pred_test_y)
print("Scikit poly 3 SVM test error = {}".format(test_error))

pred_test_y = svm_rbf(train_pca10, train_y, test_pca10)
test_error = compute_test_error_svm(test_y, pred_test_y)
print("Scikit RBF SVM test error = {}".format(test_error))
